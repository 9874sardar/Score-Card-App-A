      ...
      <View style={styles.container}>
        <View style={styles.header}>
          ...
          <Text style={styles.subtitle}>
            Login and see wonders of our app
          </Text>
        </View>
        ...
        <View style={styles.form}>
          ...
          <TouchableOpacity
            ...
            <Text style={styles.formFooter}>
              ...
              {/* <Text style={{ textDecorationLine: 'underline' }} onPress={display}>Sign up</Text> */}
            </Text>
          </TouchableOpacity>
        </View>
      </View>
